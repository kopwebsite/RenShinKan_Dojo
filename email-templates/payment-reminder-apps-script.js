...
function renderPaymentReminderEmail(details) {
  ...
  return [
    ...
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#eae0cb; background-image:url(https://renshinkan-dojo.pages.dev/parchment-texture.png); background-size:cover; background-position:center;">',
    ...
    '<img src="https://renshinkan-dojo.pages.dev/renshinkan-logo.png" width="58" height="58" alt="RenshinKan Dojo" style="width:58px; height:auto; margin:0 auto 12px auto;">',
