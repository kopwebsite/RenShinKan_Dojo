...
const phrases: Phrase[] = [
  ...
  ["Tell us whether you already have an annual membership. A student-entered payment date remains unverified until an administrator reviews it.", "แจ้งให้เราทราบว่าคุณมีสมาชิกภาพรายปีอยู่แล้วหรือไม่ วันที่ชำระเงินที่นักเรียนกรอกเองจะยังไม่ได้รับการยืนยันจนกว่าผู้ดูแลจะตรวจสอบ", "请告诉我们您是否已有年度会员资格。学生自行填写的付款日期在管理员审核前仍为未验证状态。", "現在、年会員資格をお持ちかどうかをお知らせください。生徒が入力した支払日は、管理者が確認するまで未確認のままです。"],
  ["I currently have an AAT annual membership", "ฉันมีสมาชิกภาพรายปีของ AAT อยู่ในขณะนี้", "我目前拥有 AAT 年度会员资格", "現在AATの年会員資格を持っています"],
  ["Select this to add your membership details for review.", "เลือกเพื่อเพิ่มรายละเอียดสมาชิกของคุณสำหรับการตรวจสอบ", "选择此项以添加会员信息供审核。", "選択すると会員情報を確認用に追加できます。"],
  ["No membership yet is okay.", "ยังไม่มีสมาชิกภาพก็ไม่เป็นไร", "尚未加入会员也没关系。", "まだ会員でなくても問題ありません。"],
  ["After you submit this profile, we will show simple paper and online application options.", "หลังจากส่งโปรไฟล์นี้ เราจะแสดงตัวเลือกการสมัครแบบเอกสารและออนไลน์ที่เข้าใจง่าย", "提交此资料后，我们会显示简明的纸质和在线申请方式。", "このプロフィールを提出すると、簡単な紙面申請とオンライン申請の方法が表示されます。"],
  ...
  ["Choose a month and year if you remember. An approximate answer is fine.", "หากจำได้ ให้เลือกเดือนและปี คำตอบโดยประมาณก็ได้", "如果记得，请选择月份和年份。大致时间即可。", "覚えている場合は月と年を選択してください。おおよその時期で構いません。"],
  ...
  [
    ...
    "ดำเนินการสมัครให้เสร็จ",
    "完成申请",
    "申請を完了",
  ],
  [
    "I accept the declaration above.",
    "ฉันยอมรับคำรับรองข้างต้น",
    "我接受上述声明。", "上記の宣誓に同意します。"],
  ...
  ["Look up your student record", "ค้นหาประวัตินักเรียนของคุณ", "查询您的学员记录", "自分の生徒記録を照会"],
  ["Enter the name used when the profile was created and the Student ID.", "กรอกชื่อที่ใช้ตอนสร้างโปรไฟล์และรหัสนักเรียน", "输入创建资料时使用的姓名和学员编号。", "プロフィール作成時の氏名と生徒IDを入力してください。"],
  ["The name and Student ID are sent securely and never placed in the page URL.", "ชื่อและรหัสนักเรียนจะถูกส่งอย่างปลอดภัยและไม่ปรากฏใน URL", "姓名和学员编号会安全传输，绝不会写入页面网址。", "氏名と生徒IDは安全に送信され、ページURLには含まれません。"],
  ["Your student record will appear here", "ประวัตินักเรียนของคุณจะแสดงที่นี่", "您的学员记录将显示在这里", "生徒記録がここに表示されます"],
  ["Enter the student name.", "กรอกชื่อนักเรียน", "请输入学员姓名。", "生徒氏名を入力してください。"],
  ["Enter the Student ID.", "กรอกรหัสนักเรียน", "请输入学员编号。", "生徒IDを入力してください。"],
  ["Check the name and Student ID and try again.", "ตรวจสอบชื่อและรหัสนักเรียนแล้วลองอีกครั้ง", "请检查姓名和学员编号后重试。", "氏名と生徒IDを確認して、もう一度お試しください。"],
  ["Create your student profile", "สร้างโปรไฟล์นักเรียนของคุณ", "创建您的学员资料", "生徒プロフィールを作成"],
  ["Complete the required details first. Optional membership and photo details can be added now or later.", "กรอกข้อมูลที่จำเป็นก่อน ส่วนสมาชิกและรูปภาพซึ่งไม่บังคับสามารถเพิ่มตอนนี้หรือภายหลังได้", "请先填写必填信息。可选的会员和照片信息可现在或以后添加。", "まず必須項目を入力してください。任意の会員情報と写真は今でも後でも追加できます。"],
  ["Usable immediately · review pending", "ใช้งานได้ทันที · รอตรวจสอบ", "可立即使用 · 等待审核", "すぐに利用可能・確認待ち"],
  ["Basic information", "ข้อมูลพื้นฐาน", "基本信息", "基本情報"],
  ["Your English name is the name you will use to look up this profile.", "ชื่อภาษาอังกฤษคือชื่อที่ใช้ค้นหาโปรไฟล์นี้", "英文姓名将用于查询此资料。", "英語名はこのプロフィールの照会に使用します。"],
  ["Aikido background", "ประวัติไอคิโด", "合气道经历", "合気道歴"],
  ["Tell us where you train and roughly when you began.", "บอกสถานที่ฝึกและช่วงเวลาที่เริ่มโดยประมาณ", "请告诉我们您的训练地点和大致开始时间。", "稽古場所と開始時期の目安を教えてください。"],
  ["Choose a month and Gregorian year if you remember. An approximate answer is fine.", "หากจำได้ให้เลือกเดือนและปีคริสต์ศักราช โดยประมาณได้", "如记得，请选择公历月份和年份，约数即可。", "覚えていれば月と西暦年を選んでください。おおよそで構いません。"],
  ["No AAT membership yet", "ยังไม่มีสมาชิก AAT", "尚无 AAT 会员资格", "AAT会員資格はまだありません"],
  ["AAT membership is optional here. You can register later using the paper or online form after the profile is created.", "สมาชิก AAT ไม่บังคับ คุณสามารถสมัครภายหลังด้วยแบบกระดาษหรือออนไลน์เมื่อสร้างโปรไฟล์แล้ว", "AAT 会员资格在此为可选。资料创建后可使用纸质或在线表格注册。", "AAT会員登録は任意です。プロフィール作成後に紙またはオンラインで登録できます。"],
  ["Profile photo", "รูปโปรไฟล์", "资料照片", "プロフィール写真"],
  ["Optional · add a clear portrait now or from your profile later.", "ไม่บังคับ · เพิ่มภาพบุคคลที่ชัดเจนตอนนี้หรือภายหลังจากโปรไฟล์", "可选 · 现在添加清晰头像，或稍后从资料中添加。", "任意・鮮明な顔写真を今、または後でプロフィールから追加できます。"],
  ["Choose profile photo", "เลือกรูปโปรไฟล์", "选择资料照片", "プロフィール写真を選択"],
  ["Remove photo", "ลบรูป", "移除照片", "写真を削除"],
  ["Review and create", "ตรวจสอบและสร้าง", "检查并创建", "確認して作成"],
  ["Your Student ID will be generated securely when this form is accepted.", "ระบบจะสร้างรหัสนักเรียนอย่างปลอดภัยเมื่อรับแบบฟอร์ม", "表单被接受时将安全生成学员编号。", "フォーム受付時に生徒IDが安全に生成されます。"],
  ["Not entered", "ยังไม่ได้กรอก", "未填写", "未入力"],
  ["Not selected", "ยังไม่ได้เลือก", "未选择", "未選択"],
  ["Included for review", "รวมไว้เพื่อตรวจสอบ", "已加入审核", "確認対象に追加済み"],
  ["Not added", "ไม่ได้เพิ่ม", "未添加", "未追加"],
  ["Ready to upload", "พร้อมอัปโหลด", "可上传", "アップロード準備完了"],
  ["The profile will be usable immediately with a Pending administrator review status.", "โปรไฟล์จะใช้งานได้ทันทีโดยมีสถานะรอผู้ดูแลตรวจสอบ", "资料将立即可用，状态为等待管理员审核。", "プロフィールは「管理者確認待ち」の状態ですぐに利用できます。"],
  ["Creating profile…", "กำลังสร้างโปรไฟล์…", "正在创建资料…", "プロフィールを作成中…"],
  ["Create student profile", "สร้างโปรไฟล์นักเรียน", "创建学员资料", "生徒プロフィールを作成"],
  ["Review the highlighted fields and try again.", "ตรวจสอบช่องที่เน้นแล้วลองอีกครั้ง", "请检查突出显示的字段后重试。", "強調表示された項目を確認して、もう一度お試しください。"],
  ["Profile created", "สร้างโปรไฟล์แล้ว", "资料已创建", "プロフィールを作成しました"],
  ["Your student profile has been created.", "สร้างโปรไฟล์นักเรียนของคุณแล้ว", "您的学员资料已创建。", "生徒プロフィールが作成されました。"],
  ["Your profile can be used now. It is pending administrator review.", "โปรไฟล์ของคุณใช้งานได้แล้วและกำลังรอผู้ดูแลตรวจสอบ", "您的资料现在可以使用，正等待管理员审核。", "プロフィールは今すぐ利用でき、管理者の確認待ちです。"],
  ["Name used for access", "ชื่อที่ใช้เข้าถึง", "用于访问的姓名", "照会に使う氏名"],
  ["Copy ID", "คัดลอกรหัส", "复制编号", "IDをコピー"],
  ["Copied", "คัดลอกแล้ว", "已复制", "コピーしました"],
  ["Pending administrator review", "รอผู้ดูแลตรวจสอบ", "等待管理员审核", "管理者確認待ち"],
  ["An administrator may correct the Student ID during review. If it changes, this original ID will still open the same profile.", "ผู้ดูแลอาจแก้ไขรหัสนักเรียนระหว่างตรวจสอบ หากเปลี่ยน รหัสเดิมนี้ยังเปิดโปรไฟล์เดียวกันได้", "管理员审核时可能更正学员编号。即使更改，原编号仍会打开同一资料。", "確認時に管理者が生徒IDを修正する場合があります。変更後も元のIDで同じプロフィールを開けます。"],
  ["What you can do now", "สิ่งที่ทำได้ตอนนี้", "现在可以做什么", "今できること"],
  ["Look up your profile with the name shown above and your Student ID.", "ค้นหาโปรไฟล์ด้วยชื่อด้านบนและรหัสนักเรียน", "使用上方姓名和学员编号查询资料。", "上記の氏名と生徒IDでプロフィールを照会できます。"],
  ["Add or replace your profile photo from your student profile.", "เพิ่มหรือเปลี่ยนรูปจากโปรไฟล์นักเรียน", "从学员资料中添加或更换照片。", "生徒プロフィールから写真を追加・変更できます。"],
  ["Submit training hours and examination applications.", "ส่งชั่วโมงฝึกและใบสมัครสอบ", "提交训练时数和考试申请。", "稽古時間と審査申請を提出できます。"],
  ["Review AAT and dojo contribution reminders when they apply.", "ตรวจสอบการเตือนเงินสมทบ AAT และโดโจเมื่อเกี่ยวข้อง", "在适用时查看 AAT 和道场会费提醒。", "必要に応じてAATと道場会費のお知らせを確認できます。"],
  ["Optional AAT membership", "สมาชิก AAT (ไม่บังคับ)", "可选 AAT 会员资格", "任意のAAT会員登録"],
  ["You can register on paper or online", "สมัครด้วยเอกสารหรือออนไลน์ได้", "可纸质或在线注册", "紙またはオンラインで登録できます"],
  ["AAT membership is optional here. If you decide to join, use either route below.", "สมาชิก AAT ไม่บังคับ หากต้องการสมัครให้เลือกวิธีด้านล่าง", "AAT 会员资格为可选。如决定加入，请使用以下任一方式。", "AAT会員登録は任意です。登録する場合は以下の方法を利用してください。"],
  ["Open my student profile", "เปิดโปรไฟล์นักเรียนของฉัน", "打开我的学员资料", "自分の生徒プロフィールを開く"],
  ["Back to student-record landing page", "กลับไปหน้าหลักประวัตินักเรียน", "返回学员记录首页", "生徒記録トップへ戻る"],
  ["Usable profile · pending administrator review", "โปรไฟล์ใช้งานได้ · รอผู้ดูแลตรวจสอบ", "资料可用 · 等待管理员审核", "利用可能なプロフィール・管理者確認待ち"],
  ["PENDING", "รอตรวจสอบ", "等待中", "確認待ち"],
  ["ADMIN REVIEW", "ผู้ดูแลตรวจสอบ", "管理员审核", "管理者確認"],
  ["Usable profile and training", "โปรไฟล์ที่ใช้งานได้และการฝึก", "可用资料和训练", "利用可能なプロフィールと稽古"],
  ["Create a usable profile", "สร้างโปรไฟล์ที่ใช้งานได้", "创建可立即使用的资料", "すぐ使えるプロフィールを作成"],
  ["Enter the name used on your profile and your Student ID.", "กรอกชื่อที่ใช้ในโปรไฟล์และรหัสนักเรียนของคุณ", "输入资料中使用的姓名和您的学员编号。", "プロフィールに登録した氏名と生徒IDを入力してください。"],
  ["Your student profile is ready", "โปรไฟล์นักเรียนของคุณพร้อมแล้ว", "您的学员资料已准备就绪", "生徒プロフィールの準備ができました"],
  ["You can start using your student profile now. An administrator will review the information later.", "คุณเริ่มใช้โปรไฟล์นักเรียนได้ทันที ผู้ดูแลจะตรวจสอบข้อมูลภายหลัง", "您现在即可开始使用学员资料，管理员稍后会审核信息。", "生徒プロフィールは今すぐ利用できます。情報は後ほど管理者が確認します。"],
  ["Save or photograph these details. You will use this name and Student ID to open your profile. An administrator may correct the Student ID during review; if it changes, this original ID will still open the same profile.", "บันทึกหรือถ่ายรูปข้อมูลนี้ไว้ คุณจะใช้ชื่อและรหัสนักเรียนนี้เพื่อเปิดโปรไฟล์ ผู้ดูแลอาจแก้ไขรหัสระหว่างตรวจสอบ แต่รหัสเดิมจะยังเปิดโปรไฟล์เดียวกันได้", "请保存或拍下这些信息。您将使用此姓名和学员编号打开资料。管理员审核时可能更正编号；即使更改，原编号仍可打开同一资料。", "この情報を保存するか撮影してください。この氏名と生徒IDでプロフィールを開きます。確認時にIDが修正されても、元のIDで同じプロフィールを開けます。"],
  ["You may now use your student profile to:", "ตอนนี้คุณสามารถใช้โปรไฟล์นักเรียนเพื่อ:", "您现在可以使用学员资料来：", "生徒プロフィールで次のことができます："],
  ["Apply for kyu examinations.", "สมัครสอบเลื่อนระดับคิว", "申请级位考试。", "級の審査に申し込む。"],
  ["Submit RenShinKan monthly contributions, when applicable.", "ส่งเงินสมทบรายเดือน RenShinKan เมื่อเกี่ยวข้อง", "在适用时提交 RenShinKan 月度会费。", "対象の場合、RenShinKan月会費を提出する。"],
  ["View and update your student portfolio.", "ดูและอัปเดตแฟ้มผลงานนักเรียน", "查看并更新学员档案。", "生徒ポートフォリオを表示・更新する。"],
  ["Share your portfolio with another dojo or gym.", "แชร์แฟ้มผลงานกับโดโจหรือยิมอื่น", "与其他道场或训练馆分享档案。", "別の道場やジムとポートフォリオを共有する。"],
  ["Tell us roughly when you began training.", "บอกช่วงเวลาที่เริ่มฝึกโดยประมาณ", "请告诉我们您大致何时开始训练。", "稽古を始めた時期の目安を教えてください。"],
  ["Already registered with the Aikido Association of Thailand? Add your membership details for review.", "ลงทะเบียนกับสมาคมไอคิโดแห่งประเทศไทยแล้วหรือยัง เพิ่มรายละเอียดสมาชิกเพื่อให้ตรวจสอบได้", "已在泰国合气道协会注册？请添加会员信息供审核。", "タイ合気道協会に登録済みですか？確認用に会員情報を追加してください。"],
  ["I already have a current AAT membership", "ฉันมีสมาชิก AAT ที่ยังมีผลอยู่แล้ว", "我已有有效的 AAT 会员资格", "有効なAAT会員資格を持っています"],
  ["No membership yet?", "ยังไม่มีสมาชิกใช่ไหม", "还没有会员资格？", "まだ会員ではありませんか？"],
  ["You can finish the AAT application after creating your profile.", "คุณสามารถทำใบสมัคร AAT ให้เสร็จหลังสร้างโปรไฟล์", "您可以在创建资料后完成 AAT 申请。", "プロフィール作成後にAAT申請を完了できます。"],
  ["Verify your student record", "ยืนยันประวัตินักเรียนของคุณ", "验证您的学员记录", "生徒記録を確認"],
  ["Preparing photo…", "กำลังเตรียมรูป…", "正在处理照片…", "写真を準備中…"],
  ["Preparing your photo…", "กำลังเตรียมรูปของคุณ…", "正在处理您的照片…", "写真を準備しています…"],
  ["Photo ready to upload.", "รูปพร้อมอัปโหลดแล้ว", "照片已可上传。", "写真をアップロードできます。"],
  ["Choose one from your photo library or take a new photo. JPEG, PNG, WebP, HEIC, or HEIF; up to 8 MB and at least 128 × 128 pixels.", "เลือกรูปจากคลังหรือถ่ายรูปใหม่ รองรับ JPEG, PNG, WebP, HEIC หรือ HEIF ขนาดไม่เกิน 8 MB และอย่างน้อย 128 × 128 พิกเซล", "请从照片库选择或拍摄新照片。支持 JPEG、PNG、WebP、HEIC 或 HEIF，最大 8 MB，至少 128 × 128 像素。", "写真ライブラリから選ぶか新しく撮影してください。JPEG、PNG、WebP、HEIC、HEIF、8 MB以下、128×128ピクセル以上。"],
];
