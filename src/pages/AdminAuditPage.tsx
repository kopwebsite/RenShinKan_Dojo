...
type Entry = {
  ...
  request_id: string; administrator_note?: string; action_summary: string; created_at: string;
};
...
export function AdminAuditPage() {
  ...
  const [page, setPage] = useState(1); const [filters, setFilters] = useState({ student: "", administrator: "", actorType: "", action: "", source: "", bulkOperationId: "", dateFrom: "", dateTo: "" });
