  ...
  return (
    <>
      <MotionSection className="page-opening container-shell">
        <div>
          <p className="folio-mark">{t("classes.intro.folio")}</p>
          <p className="eyebrow">{t("classes.intro.eyebrow")}</p>
          <h1>{t("classes.intro.title")}</h1>
          <p>{t("classes.intro.copy")}</p>
          <Link to="/contact" className="text-link">{t("classes.intro.visitCta")} <ArrowRight size={16} /></Link>
        </div>
        <figure>
          ...
          <figcaption>{t("classes.intro.imageCaption")}</figcaption>
        </figure>
      </MotionSection>
      ...
      <MotionSection id="schedule" className="ink-section scroll-mt-24">
        <div className="container-shell ink-section__layout">
          ...
          <div className="class-times" role="list" aria-label={t("classes.schedule.ariaLabel")}>
            ...
            <p className="class-times__note">{t("classes.schedule.arrivalNote")}</p>
          </div>
        </div>
      </MotionSection>
