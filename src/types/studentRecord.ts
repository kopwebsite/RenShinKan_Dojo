export type PublicExamination = { examination_date: string; belt_awarded: string; belt_color: string; rank?: string | null; examiner?: string | null; public_notes?: string | null };
